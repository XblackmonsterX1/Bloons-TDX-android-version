...
public abstract class DownloaderService extends CustomIntentService implements IDownloaderService {
    ...
    public static int startDownloadServiceIfRequired(Context context,
        ...
        switch (status) {
            ...
            case LVL_CHECK_REQUIRED:
				...
				Log.i("yoyo","Starting foreground service for package:" + classPackage +" className:" + className);
    ...
    public void onCreate() {
        ...
        try {
			...
			{
				String CHANNEL_ID = "APK Expansion channel 01";
				...
				Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
						.setContentTitle("APK Expansion Content Title")
						.setContentText("APK Expansion Content Text").build();
