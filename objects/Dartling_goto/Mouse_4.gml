var __b__;
__b__ = action_if_variable(global.DGL, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.DGlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Dartling_Challenge);
}
}
__b__ = action_if_variable(global.DGL, 3, 2);
if __b__
{
with (Dartling_Ups){
if DGup = 2
