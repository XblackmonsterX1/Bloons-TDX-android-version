var __b__;
__b__ = action_if_variable(global.MApM, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.MAplock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Apprentice_Challenge);
}
}
__b__ = action_if_variable(global.MApM, 3, 2);
if __b__
{
with (Apprentice_Ups){
if MApup = 5
