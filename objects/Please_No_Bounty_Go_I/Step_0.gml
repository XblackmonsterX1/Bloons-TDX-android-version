...
if global.wave > 42
{
	if global.specialmission11 < 1 {
		global.BP += 25
		global.monkeymoney += 1000
		global.specialmission11 = 1
	}
...
global.money += 2.2 * round((((global.cashwavereward) * (global.cashflow))) * (1 + global.cashinflate * 0.1));
global.money += 2.2 * (global.wealthiness * 20) - 1 + (1 * global.wave);
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Big_Bully_Bloon);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, UFO_Bloon);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
var inst;
inst = instance_create(1024, 240, Track_Crawler);
with (inst)
   {
   bloonmaxlayer = 100;
   bloonlayer = 100;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, The_Mother);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Knight_Bloon);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
