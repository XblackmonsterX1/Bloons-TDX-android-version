...
if global.track1milestone = 0
draw_text(x+96, y+34, string_hash_to_newline("Finish Monkey Meadows"));
...
draw_text(x+96, y+34, string_hash_to_newline("Monkey Meadows +50"));
if global.track1milestone = 6
draw_text(x+96, y+34, string_hash_to_newline("Monkey Meadows +100"));
