...
if global.track = 16
{
instance_change(Super_Bounty_Go_I,1)
}
if global.track = 22
{
if global.bullyenable >= 1
{
instance_change(Secret_Go,1)
}
}
if global.track = 1
{
...
{
instance_change(Clown_Go,1)
}
if global.clownenable = 2
{
instance_change(Clown_Go2,1)
}
if global.clownenable = 3
{
instance_change(Clown_Go3,1)
}
if global.clownenable = 4
{
instance_change(Clown_Go4,1)
}
if global.clownenable = 5
{
instance_change(Clown_Go5,1)
}
}
if global.track = 18 {
if global.crawlerenable = 1
{
instance_change(Crawler_Go,1)
}
if global.crawlerenable = 2
{
instance_change(Crawler_Go2,1)
}
if global.crawlerenable = 3
{
instance_change(Crawler_Go3,1)
}
if global.crawlerenable = 4
{
instance_change(Crawler_Go4,1)
}
}
...
{
instance_change(Blooming_Go,1)
}
if global.flowerenable = 2
{
instance_change(Blooming_Go2,1)
}
if global.flowerenable = 3
{
instance_change(Blooming_Go3,1)
}
if global.flowerenable = 4
{
instance_change(Blooming_Go4,1)
}
}
...
{
instance_change(tDoM_Go,1)
}
if global.destroyerenable = 2
{
instance_change(tDoM_Go2,1)
}
if global.destroyerenable = 3
{
instance_change(tDoM_Go3,1)
}
if global.destroyerenable = 4
{
instance_change(tDoM_Go4,1)
}
}
...
if global.track = 29
{
	...
	{
	instance_change(Flying_Go,1)
	}
	if global.flyingenable = 2
	{
	instance_change(Flying_Go2,1)
	}
	if global.flyingenable = 3
	{
	instance_change(Flying_Go3,1)
	}
	if global.flyingenable = 4
	{
	instance_change(Flying_Go4,1)
	}
}
...
if global.track = 17
{
	...
	{
	instance_change(Knight_Go,1)
	}
	if global.knightenable = 2
	{
	instance_change(Knight_Go2,1)
	}
	if global.knightenable = 3
	{
	instance_change(Knight_Go3,1)
	}
	if global.knightenable = 4
	{
	instance_change(Knight_Go4,1)
	}
}
...
if global.track = 27
{
	...
	{
	instance_change(Worm_Go,1)
	}
	if global.wormenable = 2
	{
	instance_change(Worm_Go2,1)
	}
	if global.wormenable = 3
	{
	instance_change(Worm_Go3,1)
	}
	if global.wormenable = 4
	{
	instance_change(Worm_Go4,1)
	}
}
...
__b__ = action_if_variable(global.wave, 87, 3);
if __b__
{
...
{
{
global.wave += 1 + irandom(global.waveskip - 1);
with (Wave_Panel)
{
...
if __b__
{
action_timeline_set(N39, 0, 0, 0);
}
__b__ = action_if_variable(global.wave, 40, 0);
if __b__
{
action_timeline_set(N40, 0, 0, 0);
}
