var __b__;
__b__ = action_if_variable(global.MSL, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.MSlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Sub_Challenge);
}
}
__b__ = action_if_variable(global.MSL, 3, 2);
if __b__
{
with (Submarine_Ups){
if MSup = 2
