var __b__;
__b__ = action_if_variable(global.MLR, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.MLlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Mortar_Challenge);
}
}
__b__ = action_if_variable(global.MLR, 3, 2);
if __b__
{
with (Mortar_Ups){
if MLup = 8
