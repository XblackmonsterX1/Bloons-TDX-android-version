...
global.money += 1.1 * round((((global.cashwavereward) * (global.cashflow))) * (1 + global.cashinflate * 0.1));
global.money += 1.1 * (global.wealthiness * 20) - 1 + (1 * global.wave);
...
var inst;
inst = instance_create(400, 240, Sprout_Bloon);
with (inst)
   {
   bloonmaxlayer = 9;
   bloonlayer = 9;
...
{
var inst;
inst = instance_create(400, 240, Blooming_Bloon);
with (inst)
   {
   bloonmaxlayer = 9;
   bloonlayer = 9;
