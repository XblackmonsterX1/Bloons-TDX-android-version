var __b__;
__b__ = action_if_variable(global.MEM, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.MElock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Engineer_Challenge);
}
}
__b__ = action_if_variable(global.MEM, 3, 2);
if __b__
{
with (Engineer_Ups){
if MEup = 5
