var __b__;
__b__ = action_if_variable(global.HPL, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.HPlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Heli_Challenge);
}
}
__b__ = action_if_variable(global.HPL, 3, 2);
if __b__
{
with (Heli_Ups){
if HPup = 2
