var __b__;
__b__ = action_if_variable(global.SFM, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.SFlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Spactory_Challenge);
}
}
__b__ = action_if_variable(global.SFM, 3, 2);
if __b__
{
with (Spike_Ups){
if SFup = 5
