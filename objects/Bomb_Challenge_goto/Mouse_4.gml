var __b__;
__b__ = action_if_variable(global.BCR, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.BClock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Bomb_Challenge);
}
}
__b__ = action_if_variable(global.BCR, 3, 2);
if __b__
{
with (Bomb_Ups){
if BCup = 8
