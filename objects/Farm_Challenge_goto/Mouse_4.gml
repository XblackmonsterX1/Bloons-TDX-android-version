var __b__;
__b__ = action_if_variable(global.BTM, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.BTlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Farm_Challenge);
}
}
__b__ = action_if_variable(global.BTM, 3, 2);
if __b__
{
with (Farm_Ups){
if BTup = 5
