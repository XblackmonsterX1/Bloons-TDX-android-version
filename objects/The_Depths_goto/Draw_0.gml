...
action_draw_sprite(The_Depths_Panel, 0, 0, -1);
if global.horrorenable > 0
draw_sprite(Horror_Bloon,0,x+120,y+96)
if global.b3 > 0
draw_sprite(Bounty_Medals,global.b3 + 7,x+56,y+168)
