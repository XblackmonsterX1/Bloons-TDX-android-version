var __b__;
__b__ = action_if_variable(global.GGM, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.GGlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Glue_Challenge);
}
}
__b__ = action_if_variable(global.GGM, 3, 2);
if __b__
{
with (Glue_Ups){
if GGup = 5
