...
if global.wave > 52
{
	if global.specialmission11 < 4 {
		global.BP += 40
		global.monkeymoney += 1200
		global.specialmission11 = 4
	}
...
global.money += 3 * round((((global.cashwavereward) * (global.cashflow))) * (1 + global.cashinflate * 0.1));
global.money += 3 * (global.wealthiness * 20) - 1 + (1 * global.wave);
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Big_Bully_Bloon_Red);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Big_Bully_Bloon_Blue);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Big_Bully_Bloon_Green);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Big_Bully_Bloon_Yellow);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Flying_Bloon);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Blooming_Bloon);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Mothership);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
wormspawn = 75;
global.hitpoints = 30500;
global.maxpoints = 30500;
alarm[1] = 30
}
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Almighty_Bloon);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
var inst;
inst = instance_create(1024, 240, Widow_Bloon);
with (inst)
   {
   bloonmaxlayer = 100;
   bloonlayer = 100;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Eternal_Spring_Bloon);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
wormspawn = 70;
global.hitpoints = 35500;
global.maxpoints = 35500;
alarm[2] = 30
}
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, tDoM_Phase_Zero);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
with (BloonSpawn) {
var inst;
inst = instance_create(x, y, Parade_Bloon);
with (inst)
   {
   bloonmaxlayer = 1000;
   bloonlayer = 1000;
...
var inst;
inst = instance_create(1024, 40, Widow_Bloon);
with (inst)
   {
   bloonmaxlayer = 100;
   bloonlayer = 100;
   ...
   var inst;
inst = instance_create(1024, 440, Widow_Bloon);
with (inst)
   {
   bloonmaxlayer = 100;
   bloonlayer = 100;
