...
if bloonlayer = 5
{
sprite_index = Bomber_Bloon_Spr;
image_xscale = 1.4;
image_yscale = 1.4;
fast = global.bspeed * 11
image_index = 4
}
if bloonlayer = 4
{
...
image_xscale = 1.1;
image_yscale = 1.1;
fast = global.bspeed * 9.5
image_index = 1
      }
if bloonlayer = 1
{
sprite_index = Water_Bloon_Spr;
image_xscale = 1;
image_yscale = 1;
fast = global.bspeed * 4
image_index = 0
      }
