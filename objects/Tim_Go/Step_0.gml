...
global.money += 0.66 * round((((global.cashwavereward) * (global.cashflow))) * (1 + global.cashinflate * 0.1));
global.money += 0.66 * (global.wealthiness * 20) - 1 + (1 * global.wave);
...
var inst;
inst = instance_create(400, 240, Bloon_Tim_Phase_1);
with (inst)
   {
   bloonmaxlayer = 9;
   bloonlayer = 9;
