var __b__;
__b__ = action_if_variable(global.CTL, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.CTlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Charge_Challenge);
}
}
__b__ = action_if_variable(global.CTL, 3, 2);
if __b__
{
with (Charge_Ups){
if CTup = 2
