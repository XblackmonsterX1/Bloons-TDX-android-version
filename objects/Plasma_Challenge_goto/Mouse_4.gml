var __b__;
__b__ = action_if_variable(global.PML, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.PMlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Plasma_Challenge);
}
}
__b__ = action_if_variable(global.PML, 3, 2);
if __b__
{
with (Plasma_Ups){
if PMup = 2
