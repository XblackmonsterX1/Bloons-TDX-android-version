var __b__;
__b__ = action_if_variable(global.MVR, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.MVlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Village_Challenge);
}
}
__b__ = action_if_variable(global.MVR, 3, 2);
if __b__
{
with (Village_Ups){
if MVup = 8
