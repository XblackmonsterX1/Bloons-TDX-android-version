var __b__;
__b__ = action_if_variable(global.MBL, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.MBlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Bucc_Challenge);
}
}
__b__ = action_if_variable(global.MBL, 3, 2);
if __b__
{
with (Buccaneer_Ups){
if MBup = 2
