...
global.money += 1.7 * round((((global.cashwavereward) * (global.cashflow))) * (1 + global.cashinflate * 0.1));
global.money += 1.7 * (global.wealthiness * 20) - 1 + (1 * global.wave);
...
if __b__
{
action_timeline_set(Super_25_II, 0, 0, 0);
}
...
if __b__
{
action_timeline_set(Super_30_II, 0, 0, 0);
}
...
if __b__
{
action_timeline_set(UFO_2_Star_35, 0, 0, 0);
}
...
if __b__
{
action_timeline_set(Might_Moab_2_Star_37, 0, 0, 0);
}
...
if __b__
{
action_timeline_set(Mother_2_Star_39, 0, 0, 0);
}
__b__ = action_if_variable(global.wave, 40, 0);
if __b__
{
action_timeline_set(LUL_2_Star_40, 0, 0, 0);
}
