if bloonlayer = 1 
maxarmour = ceil(9 * global.bpower)
if bloonlayer = 2
maxarmour = ceil(18 * global.bpower)
if bloonlayer = 3
maxarmour = ceil(27 * global.bpower)
if bloonlayer = 4
maxarmour = ceil(36 * global.bpower)
if bloonlayer = 5
maxarmour = ceil(45 * global.bpower)
if bloonlayer = 10
maxarmour = ceil(90 * global.bpower)
