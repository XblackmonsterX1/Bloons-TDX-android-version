var __b__;
__b__ = action_if_variable(global.IMR, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.IMlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Ice_Challenge);
}
}
__b__ = action_if_variable(global.IMR, 3, 2);
if __b__
{
with (Ice_Ups){
if IMup = 8
