if global.normalmodeselect = 1 || global.impoppablemodeselect = 1 || global.nightmaremodeselect = 1 {
	...
	room_goto(Lawless_Badlands_Norm);
	if global.trackselect = 34
	room_goto(Lost_Pools_Norm);
}
...
if global.trackselect = 33
room_goto(Lawless_Badlands_Time);
if global.trackselect = 34
room_goto(Lost_Pools_Time);
}
...
if global.normalmodeselect = 1 or global.impoppablemodeselect = 1 or global.nightmaremodeselect = 1 
...
{
global.pointmultiplier = global.pointmultiplier * 1.3
}
if global.strongerbloons = 3 {
global.pointmultiplier = global.pointmultiplier * 1.9
}
...
{
global.pointmultiplier = global.pointmultiplier * 1.4
}
}
