var __b__;
__b__ = action_if_variable(global.MAlR, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.MAllock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Alchemist_Challenge);
}
}
__b__ = action_if_variable(global.MAlR, 3, 2);
if __b__
{
with (Alchemist_Ups){
if MAlup = 8
