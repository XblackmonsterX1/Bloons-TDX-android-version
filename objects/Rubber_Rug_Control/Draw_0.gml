...
global.track27milestone = 4
global.BP += 5
global.monkeymoney += 150
}
if global.wave > 140
if global.track27milestone < 5
{
with instance_create(476,240,Mile_Stones)
{
difficulty = 0
}
global.track27milestone = 5
global.BP += 5
global.monkeymoney += 150
}
if global.wave > 190
...
global.track27hardstone = 5
global.BP += 6
global.monkeymoney += 180
}
if global.wave > 175
if global.track27hardstone < 6
{
with instance_create(476,240,Mile_Stones)
{
difficulty = 10
}
global.track27hardstone = 6
global.BP += 6
global.monkeymoney += 180
}
}
...
global.track27nightstone = 4
global.BP += 7
global.monkeymoney += 210
}
if global.wave > 110
if global.track27nightstone < 5
{
with instance_create(476,240,Mile_Stones)
{
difficulty = 20
}
global.track27nightstone = 5
global.BP += 7
global.monkeymoney += 210
}
if global.wave > 160
if global.track27nightstone < 6
{
with instance_create(476,240,Mile_Stones)
{
difficulty = 20
}
global.track27nightstone = 6
global.BP += 7
global.monkeymoney += 210
}
}
