var __b__;
__b__ = action_if_variable(global.BChM, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.BChlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Chipper_Challenge);
}
}
__b__ = action_if_variable(global.BChM, 3, 2);
if __b__
{
with (Chipper_Ups){
if BChup = 5
