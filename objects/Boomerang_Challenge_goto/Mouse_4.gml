var __b__;
__b__ = action_if_variable(global.BML, 3, 0);
if __b__
{
{
global.challenge = 0
...
{
global.BMlock = 1 + ds_list_find_value(tower_locks, 2);
...
action_another_room(Boomerang_Challenge);
}
}
__b__ = action_if_variable(global.BML, 3, 2);
if __b__
{
with (Boomerang_Thrower_Ups){
if BMup = 2
BMup = 13
if BMup = 3
BMup = 14
